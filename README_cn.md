...
这是 [erosTeam/eros_fe](https://github.com/erosTeam/eros_fe) 的**个人定制 fork**，更名为 **Eros-EH+**（包名 `com.ldwdg.erosehentai`，版本 v1.0.0）。

## 本 fork 的新变化

- **更名**：应用名 `Eros-EH+`，Android 包名 `com.ldwdg.erosehentai`，版本 `1.0.0`
